...
if __name__ == "__main__":
    ...
    compare_df = joblib.Parallel(n_jobs=3, verbose=50)(
    ...
    result_df.to_csv("sample_size_report/results/samplesize_result_%d.csv" % (sample_size), index=False)
